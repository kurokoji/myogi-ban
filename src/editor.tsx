      ...
      <aside id="sidebar">
        ...
        <Paper className="panel" withBorder>
          <Stack gap="xs">
            ...
            <Button size="xs" variant="light" fullWidth onClick={() => updateLayout((next) => { next.buttons = next.buttons.map(() => ({ x: next.defaultbuttons.x, y: next.defaultbuttons.y, w: next.defaultbuttons.w, h: next.defaultbuttons.h, img: next.defaultbuttons.img, xp: next.defaultbuttons.xp, yp: next.defaultbuttons.yp, wp: next.defaultbuttons.wp, hp: next.defaultbuttons.hp, imgp: next.defaultbuttons.imgp, useCss: next.defaultbuttons.useCss, cssColor: next.defaultbuttons.cssColor, cssPressedColor: next.defaultbuttons.cssPressedColor, cssTransition: next.defaultbuttons.cssTransition, cssEasing: next.defaultbuttons.cssEasing })); })}>{t('resetAllToDefault')}</Button>
            <Switch
              size="sm"
